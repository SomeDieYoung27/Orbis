...
class OrchestrationAgent:
    ...
    async def shutdown_agents(self) -> None:
         ...
         try:
              ...
              for name,agent in self.agents.items():
                    ...
                    cleanup_tasks.append(agent.shutdown())
    ...
    async def process_request(self,request : Dict[str,Any]) -> Dict[str,Any]:
         ...
         try:
              ...
              if operation == "create":
                   result = await self.handle_create(request)
              elif operation == "read":
                   result = await self.handle_read(request)
              elif operation == "update":
                     result = await self.handle_update(request)
              elif operation == "delete":
                        result = await self.handle_delete(request)
              elif operation == "list":
                        result = await self.handle_list(request)
              else:
    ...
    async def _handle_create(self,request : Dict[str,Any]) -> Dict[str,Any]:
          ...
          await self.agents["analytics"].process({
    ...
    async def get_workflow_request(self,workflow_id : str) -> Dict[str,Any]:
