...
class DataQueryAgent(BaseAgent):
    async def initialize(self) -> Dict[str,Any]:
        ...
        try:
            ...
            raise QueryError(f"Failed to initialize OpenAI client: {str(e)}")
    ...
    async def process(self,request : Dict[str,Any]) -> Dict[str,Any]:
        ...
        try:
            ...
            raise QueryError(f"Failed to process query request: {str(e)}")


    async def handle_read(self,request : Dict[str,Any]) -> Dict[str,Any]:
